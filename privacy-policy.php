				...
				<div class="col-sm-9 padding-right">
					<div class="features_items"><!--features_items-->
						...
						<h3 class="title"> Introduction and Overview</h3>
							<p class="paragraph"> You have arrived at a web site that is provided by Alastair's (“Alastair's” or “we,” “our” or “us”). This “Privacy Policy” governs your use of www.alistairs.com and any other official Alastair's sites (including mobile sites or apps), and any interactive features, applications, and/or other services that we make available through a site that posts a link to this Privacy Policy (collectively, referred to as the “Site”). This Privacy Policy also applies to Personal Information (defined below) we may collect from you in our Alastair's retail stores (“Store” or “Stores”), and through official surveys and sweepstakes entry forms, or in any other instance when you contact us.</p>
							<p class="paragraph">This Privacy Policy describes what information Alastair's collects about you, why we collect it, how we use it, and under what circumstances we share it with third parties. This Privacy Policy also describes the choices you can make about how we use your information. To the extent we provide you notice on our Site or in our Stores of different or additional privacy policies or practices (e.g., at the point of our collection), those additional terms shall govern such data collection and use.</p>
						...
						<h3 class="title">Information You Provide To Us</h3>
							<p class="paragraph">We may ask you to provide us: (1) your first and last name, email address, home address, phone number, driver’s license number, credit and debit card numbers, checking account numbers, date of birth and social security number (when applying for or requesting services related to the Alastair's Rewards Card) or other information that could reasonably be used to identify you personally (hereinafter “Personal Information”); and/or (2) demographic information, such as information like your zip code (“Demographic Information”). We may collect this information from you such as when you:</p>
								<ul class="privacylist"> 
									<li>Submit account registration forms</li>
									<li>Sign up for Alastair's Rewards Card</li>
